...
The web app handles the full workflow: upload a dataset, preprocess it, train a topic model, run detection, review results. No code required.
...
**Supported LLM backends:** Gemini (2.0-flash, 2.5-flash), OpenAI (GPT-4o, GPT-4, GPT-3.5-turbo), Ollama, vLLM, and llama.cpp. One line in `config.yaml` switches between them.
